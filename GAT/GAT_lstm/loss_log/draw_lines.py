...
with open('loss_005.txt', 'r') as file1:
    for line in file1:
        try:
...
plt.plot(x_values, file1_contents, label='lr=0.005')
plt.plot(x_values, file2_contents, label='lr=0.012')

# Add labels, title, legend, etc.
plt.xlabel('# epoch')
plt.ylabel('training loss')
plt.title('Line Plot of lr=5e-3 and lr=12e-3')
plt.legend()
