		...
		for epoch in range(args.num_epochs):
			...
			if args.num_batch > 1:
				...
				for step, (input_nodes, seeds, blocks) in enumerate(b_block_dataloader):
					print(len(input_nodes)/len(seeds)/50/0.411)
					redundant_ratio.append(len(input_nodes)/len(seeds)/50/0.411)
				...
				print('1-40, 41-49 degree')
				print(modified_res[:2])
				print('50 degree split 26 parts')
				print(modified_res[2:27])
